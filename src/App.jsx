...
const App = () => {
  ...
  const [totalPrice, setToltal] = useState("");
  ...
  let getDataTwo = async () => {
    try {
      const data = await axios({
        method: "get",
        url: "http://localhost:4000/users",
      });
      setUsertwo(data.data);
    } catch (err) {
      setUsertwo("Not Found");
    }
  };
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route path="/sign in" element={<SignIn renderApp={renderApp} />} />
        <Route
          path="/create account"
          element={<CreateAccount getDataTwo={getDataTwo} usertwo={usertwo} />}
        />
        <Route
          path="/cart"
          element={
