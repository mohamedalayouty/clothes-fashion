...
const Footer = () => {
    return (
        ...
        <div className='mt-12'>
            ...
            <h1 className='mb-4 text-sm'>The customer is at the heart of our uniqe business model,
                which includes design.</h1>
            <div className=''>
            ...
            <h1 className='text-sm mb-8'>Be the first to know about new arrivals,
            look books, salse & promos!</h1>
        ...
        <hr className=' w-3/4 absolute mt-6'/>
        <div className=' absolute copy bottom-0 mb-1'>
