            ...
            <div className="flex justify-between">
              <div className="grid gap-20 mt-4">
                <h1 className=" text-white font-semibold">
                  First Name :{" "}
                  <span className="text-blue-600">{profileUser.firstName}</span>
                </h1>
                <h1 className=" text-white font-semibold">
                  UserName :{" "}
                  <span className="text-blue-600">{profileUser.username}</span>
                </h1>
                <h1 className=" text-white font-semibold">
                  Password :{" "}
                  <span className="text-blue-600">{profileUser.password}</span>
                </h1>
                <h1 className=" text-white font-semibold">
                  City :{" "}
              ...
              <div className="grid gap-12 mt-4 me-4">
                <h1 className=" text-white font-semibold">
                  Last Name :{" "}
                  <span className="text-blue-600">{profileUser.lastName}</span>
                </h1>
                <h1 className=" text-white font-semibold">
                  Email :{" "}
                  <span className="text-blue-600">{profileUser.userEmail}</span>
                </h1>
                <h1 className=" text-white font-semibold">
                  Gender :{" "}
