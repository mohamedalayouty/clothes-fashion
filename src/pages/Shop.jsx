...
<div className='mt-8 grid grid-cols-2 gap-4 mx-4 md:grid-cols-4'>
    {
            ...
            <button onClick={() =>addProduct(product)}><img src={product.img} alt="profile-picture" className=' h-56 w-48'/></button>  
            </CardHeader>
            <CardBody className="text-center">
              <Typography color="blue-gray" className="font-medium text-[#0f172a]" textGradient>
                {product.description}
              </Typography>
              <Typography color="blue-gray" className="font-medium text-[#0f172a]" textGradient>
                {product.name}
